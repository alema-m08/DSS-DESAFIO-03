...
class Router {
    ...
    public function add($method, $route, $handler) {
        // Convertir rutas dinámicas como /tareas/editar/{id} a expresiones regulares
    ...
    public function dispatch() {
        ...
        // Extraer la ruta sin parámetros query (?foo=bar)
        $path = parse_url($requestUri, PHP_URL_PATH);
        
        // Determinar la ruta relativa desde la carpeta del proyecto
